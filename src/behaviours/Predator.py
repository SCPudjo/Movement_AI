...
class Predator:
    ...
    def __init__(self, creature):
        ...
        self.prey = None
        self.reach = int(PREDATOR['reach'])

        self.creature.radius = int(PREDATOR['radius'])
        self.creature.vision = int(PREDATOR['vision'])
        self.creature.movement_speed = float(PREDATOR['movement_speed']) / 10
        self.creature.turn_speed = float(PREDATOR['turn_speed']) / 100
        self.creature.distance = int(PREDATOR['distance'])
